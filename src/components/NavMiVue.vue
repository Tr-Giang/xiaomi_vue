  ...
  <header>
    ...
    <div class="header__box" :class="{ show: store.isShowNav }">
            ...
            <header-subnav-mi :subNav="homeNav[3]">
              <template #image
                ...
                >
                  ...
                  ></path></svg
              ></template>
              <template #name> <span>Thiết bị thông minh</span> </template>
            </header-subnav-mi>
          </template>
        </header-navbar-mi>
        <header-navbar-mi :nav="style">
          ...
          <template #subnav>
            ...
            <header-subnav-mi :subNav="styleNav[3]">
              ...
              <template #name><span>Phụ kiện</span></template>
            </header-subnav-mi>
          </template>
        </header-navbar-mi>
      </ul>
      ...
      <div class="header__respon">
        <header-respon-mi>
          <template #name>HỖ TRỢ</template>
          <template #item>
            <header-respon-child>
              <template #link><a href="#!">Hướng dẫn sử dụng</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Bảo hành</a> </template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Mua hàng</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Trung tâm dịch vụ</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Xác thực sản phẩm</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link
                ><a href="#!"
                  >Phí sửa chữa dịch vụ đối với điện thoại</a
                ></template
              >
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Email</a></template>
            </header-respon-child>
          </template>
        </header-respon-mi>
        <header-respon-mi>
          <template #name>Giới thiệu</template>
          <template #item>
            <header-respon-child>
              <template #link><a href="#!">Xiaomi</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Đội ngũ lãnh đạo</a> </template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Chính sách riêng tư</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Toàng vẹn & tuân thủ</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">Trust Center</a></template>
            </header-respon-child>
            <header-respon-child>
              <template #link><a href="#!">MIUI</a></template>
            </header-respon-child>
          </template>
        </header-respon-mi>
      </div>
